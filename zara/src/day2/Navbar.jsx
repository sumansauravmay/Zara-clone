...
<Flex mt="20px" ml="200px" minWidth='max-content' alignItems='center' gap='2'>
  <ButtonGroup gap='2' position="absolute">
    <Button bg="white">NEW</Button>
    <Button bg="white">THE JEANS REDESIGN X ZARA</Button>
    <Button bg="white">Y2 | METAVERSE</Button>
    <Button bg="white">BEST SELLERS</Button>
    <Button bg="white">COLLECTION</Button>
    <Button bg="white">BASICS</Button>
    <Button bg="white">SHOES</Button>
  </ButtonGroup>
</Flex>
